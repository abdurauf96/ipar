 <section class="container-fluid slider1">
  <div class="container slider1__head">
    <p class="slider1__head--text">  @lang('part.novinki') </p>
  </div>
  <div class="container slider1__wrapper">
    @foreach($products as $product)
    <div class="slider1__item zakas">
      ...
      <div class="back side"><a href="{{ route('product_view', ['id'=>$product->id]) }}">@lang('part.podrobne')</a></div>
    </div>
    @endforeach
  </div>
</section>